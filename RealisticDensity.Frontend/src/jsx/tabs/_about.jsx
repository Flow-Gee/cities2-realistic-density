...
const $About = ({}) => {
    ...
    return <div>
        <$IconPanel label="Realistic Density v0.0.7" style={{ flex: 1 }}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', width: '100%' }}>
            <$Description style={{ paddingTop: '0' }}>
                <$Paragraph>
                    Our mods, including "Realistic Density," are part of a vibrant creative effort, officially distributed via <b>Thunderstore.io</b>&nbsp;and our GitHub repository. They represent not just our work but the spirit of collaboration and innovation within the Cities Skylines modding community.
                </$Paragraph>
                <$Paragraph>
                    Special thanks to <b>optimus-code</b>,&nbsp;<b>Captain_Of_Coit</b>&nbsp;and <b>Rebecca</b>, as well as the extensive <b>Cities2Modding</b>&nbsp;community.
                </$Paragraph>
                <$Paragraph>

...
import Changelog from "./components/_changelog.jsx";

const About = ({ model, trigger }) => {
                    ...
                    <div className="bg-black-trans-less-faded rounded-sm">
                        <div className="p-4">
                            <p className="mb-3 d-flex flex-row align-items-center">
                                <strong>...for using RealisticDensity for your city planning!</strong>
                ...
                <div className="my-3">
                    ...
                    <div className="p-4 bg-black-trans-less-faded rounded-sm">
                        <div className="d-flex flex-row justify-content-space-between" style={{ justifyContent: 'space-between' }}>
                            <Button className="d-flex flex-row align-items-center" color="primary" style="trans" onClick={() => launchUrl("https://discord.gg/KGRNBbm5Fh")}>
                            ...
                            <Button className="d-flex flex-row align-items-center" color="primary" style="trans" onClick={() => launchUrl("https://github.com/89pleasure/cities2-realistic-density")}>
                                <Icon icon="https://raw.githubusercontent.com/prplx/svg-logos/master/svg/github-icon.svg" className="mr-2" />
                                <p>Code on Github</p>
                            </Button>
                            <Button className="d-flex flex-row align-items-center" color="primary" style="trans" onClick={() => launchUrl("https://www.reddit.com/r/cities2modding")}>
                ...
                <div className="mt-3">
                    <Grid className="align-items-center">
                        ...
                        <div className="col-3 fs-sm text-muted">
                            <Button style="trans" color="light" size="sm" onClick={() => launchUrl("https://github.com/Cities2Modding/Gooee")}>Learn more</Button>
                        </div>
                    </Grid>
                </div>
            </div>
